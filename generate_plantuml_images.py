...
os.makedirs(output_folder_puml, exist_ok=True)
os.makedirs(output_folder_png, exist_ok=True)

jar_path = os.path.join(desktop_path, "plantuml.jar")
if not os.path.exists(jar_path):
    ...
    try:
        ...
        print("Downloaded plantuml.jar successfully.")
    except Exception as e:
        print(f"Failed to download plantuml.jar: {e}")

diagrams = [
    # 7. Activity Diagrams
    ("7.1_Activity_Manage_Profile", """@startuml
...
@enduml"""),
    ...
    ("7.2_Activity_Set_Quit_Date", """@startuml
...
@enduml"""),
    ...
    ("7.3_Activity_View_Quit_Plan", """@startuml
...
@startuml"""),
    ...
    ("7.4_Activity_Daily_Check_in", """@startuml
...
@startuml"""),
    ...
    ("7.5_Activity_Track_Saving", """@startuml
...
@startuml"""),
    ...
    ("7.6_Activity_Craving_Support", """@startuml
...
@startuml"""),
    ...
    ("7.7_Activity_Start_Survival_Timer", """@startuml
...
@startuml"""),
    ...
    ("7.8_Activity_Breathing_Exercise", """@startuml
...
@startuml"""),
    ...
    ("7.9_Activity_Quick_Distraction", """@startuml
...
@startuml"""),
    ...
    ("7.10_Activity_Access_Peer_Support_Group", """@startuml
...
@startuml"""),
    ...
    # 8. Sequence Diagrams
    ("8.1_Sequence_Manage_Profile", """@startuml
...
@startuml"""),
    ...
    ("8.2_Sequence_Set_Quit_Date", """@startuml
...
@startuml"""),
    ...
    ("8.3_Sequence_View_Quit_Plan", """@startuml
...
@startuml"""),
    ...
    ("8.4_Sequence_Daily_Check_in", """@startuml
...
@startuml"""),
    ...
    ("8.5_Sequence_Track_Saving", """@startuml
...
@startuml"""),
    ...
    ("8.6_Sequence_Craving_Support", """@startuml
...
@startuml"""),
    ...
    ("8.7_Sequence_Start_Survival_Timer", """@startuml
...
@startuml"""),
    ...
    ("8.8_Sequence_Breathing_Exercise", """@startuml
...
@startuml"""),
    ...
    ("8.9_Sequence_Quick_Distraction", """@startuml
...
@startuml"""),
    ...
    ("8.10_Sequence_Access_Peer_Support_Group", """@startuml
...
@startuml"""),
    ...
    # 9. Swimlane Diagrams
    ("9.1_Swimlane_Manage_Profile", """@startuml
...
@startuml"""),
    ...
    ("9.2_Swimlane_Set_Quit_Date", """@startuml
...
@startuml"""),
    ...
    ("9.3_Swimlane_View_Quit_Plan", """@startuml
...
@startuml"""),
    ...
    ("9.4_Swimlane_Daily_Check_in", """@startuml
...
@startuml"""),
    ...
    ("9.5_Swimlane_Track_Saving", """@startuml
...
@startuml"""),
    ...
    ("9.6_Swimlane_Craving_Support", """@startuml
...
@startuml"""),
    ...
    ("9.7_Swimlane_Start_Survival_Timer", """@startuml
...
@startuml"""),
    ...
    ("9.8_Swimlane_Breathing_Exercise", """@startuml
...
@startuml"""),
    ...
    ("9.9_Swimlane_Quick_Distraction", """@startuml
...
@startuml"""),
    ...
    ("9.10_Swimlane_Access_Peer_Support_Group", """@startuml
...
# Step 1: Save all .puml files
print("Writing PlantUML files...")
for filename, content in diagrams:
    file_path = os.path.join(output_folder_puml, f"{filename}.puml")
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(content)
print(f"Saved {len(diagrams)} .puml files in {output_folder_puml}")

# Step 2: Compile .puml files to PNG images using plantuml.jar or kroki online fallback if needed
if os.path.exists(jar_path):
    print("Compiling .puml files using Java PlantUML JAR...")
    cmd = f'java -jar "{jar_path}" -tpng "{output_folder_puml}\\*.puml" -o "{output_folder_png}"'
    res = subprocess.run(cmd, shell=True, capture_output=True, text=True)
    print("Java Execution Output:", res.stdout)
    if res.stderr:
        print("Java Execution Stderr:", res.stderr)

# Verify generated images
generated_images = glob.glob(os.path.join(output_folder_png, "*.png"))
print(f"Total PNG images generated: {len(generated_images)}")

if len(generated_images) < len(diagrams):
    print("Using Kroki/PlantUML online API to render missing diagram images...")
    import base64
    import zlib
    import urllib.request

    # PlantUML text encoding algorithm for plantuml.com/plantuml/png/
    ...
    for filename, content in diagrams:
        out_png = os.path.join(output_folder_png, f"{filename}.png")
        if not os.path.exists(out_png):
            try:
                encoded = plantuml_encode(content)
                url = f"http://www.plantuml.com/plantuml/png/{encoded}"
                urllib.request.urlretrieve(url, out_png)
                print(f"Rendered online: {filename}.png")
            except Exception as e:
                print(f"Failed online render for {filename}: {e}")

final_images = glob.glob(os.path.join(output_folder_png, "*.png"))
print(f"Final Count of Diagram PNG Images in Folder: {len(final_images)}")
