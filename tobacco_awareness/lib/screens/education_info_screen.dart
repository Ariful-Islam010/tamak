              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildArticleCard(
                    context,
                    "১. স্বাস্থ্যঝুঁকি",
                    "তামাকের কারণে ফুসফুস ও হার্টের ক্ষতি, স্ট্রোক, মুখ ও মাড়ির ক্যান্সার এবং স্ট্যামিনা কমে যাওয়ার ভয়ংকর দিকগুলো সম্পর্কে জানুন।",
                  ...
                  _buildArticleCard(
                    context,
                    "২. তাৎক্ষণিক লাভ",
                    "তামাক, জর্দা বা গুল ছাড়া ২০ মিনিট থেকে ৪৮ ঘণ্টার মধ্যে রক্তচাপ স্বাভাবিক হওয়া ও হার্ট অ্যাটাকের ঝুঁকি কমার তথ্য নিন।",
                    Icons.trending_up,
                    AppTheme.primaryGreen,
                  ),
                  _buildArticleCard(
                    context,
                    "৩. দৃঢ় প্রতিজ্ঞা ও পরিবেশ",
                    "তামাক ছাড়ার শক্ত মনস্থির করুন এবং চোখের সামনে থেকে বিড়ি, তামাক, জর্দার কৌটা, গুল ও লাইটার ফেলে দিন।",
                  ...
                  _buildArticleCard(
                    context,
                    "৪. সঙ্গ ও বিকল্প",
                    "একাকীত্ব এড়াতে পরিবার বা বন্ধুদের সাথে থাকুন এবং তামাকের নেশা উঠলে চুইংগাম, আদা বা লবঙ্গ চিবান।",
                    Icons.people_outline,
                    Colors.purple,
                  ),
                  _buildArticleCard(
                    context,
                    "৫. মানসিক চাপ ও ছোট লক্ষ্য",
                    "চাপ কমাতে ডিপ-ব্রিথিং বা ধ্যান করুন এবং প্রতিদিন 'আজকে কোনো ধরনের তামাক খাব না'—এই ছোট লক্ষ্য নিন।",
                  ...
                  _buildArticleCard(
                    context,
                    "৬. পুরস্কার",
                    "প্রতি সপ্তাহে তামাকমুক্ত থাকলে বেঁচে যাওয়া টাকা দিয়ে নিজেকে পুরস্কৃত করুন বা পছন্দের খাবার খান।",
                  ...
                  _buildArticleCard(
                    context,
                    "৭. ক্র্যাভিং সামলানো",
                    "তামাক ব্যবহারের তীব্র ইচ্ছা বা 'ক্র্যাভিং' হলে ৫-৪-৩-২-১ গ্রাউন্ডিং টেকনিক ব্যবহার করুন এবং ১০ মিনিটের 'উইথড্রয়াল ওয়েভ' পার করুন।",
                    Icons.waves,
                    Colors.cyan,
                  ),
                  _buildArticleCard(
                    context,
                    "৮. অনুপ্রেরণা",
                    "তামাকমুক্ত জীবন বেছে নেওয়া একটি সাহসী ও বুদ্ধিমান সিদ্ধান্ত—এই পজিティブ বার্তা দিয়ে শেষ করুন।",
                  ...
                  _buildMythFactCard(
                    ...
                    fact: "ভুল! ই-সিগারেট ও ভ্যাপিংয়েও নিকোটিন থাকে যা আসক্তি তৈরি করে এবং ফুসফুসের জন্য ক্ষতিকর।",
                  ),
                  _buildMythFactCard(
                    context,
                  ...
                  _buildMythFactCard(
                    context,
                    myth: "হালকা (Light) বা ফিল্টারযুক্ত তামাক সাধারণ তামাকের চেয়ে নিরাপদ।",
                    fact: "ভুল! গবেষণায় দেখা গেছে লাইট তামাকের ব্যবহারেও ফুসফুসের ক্যান্সার ও হৃদরোগের ঝুঁকি একটুও কমে না।",
                  ),
                  _buildMythFactCard(
                    context,
                    myth: "হুক্কা বা শিশা (Shisha) সেবন সাধারণ তামাকের চেয়ে কম ক্ষতিকর।",
                    fact: "ভুল! হুক্কার পানি ধোঁয়াকে ফিল্টার করতে পারে না। মাত্র এক ঘণ্টার হুক্কা সেশন মারাত্মক পরিমাণ ক্ষতিকর ধোঁয়া ছড়ায়।",
                  ),
                  ...
                  _buildArticleCard(
                    ...
                    "তামাক সেবন ফুসফুসের ক্যান্সারের প্রধান কারণ। এছাড়া এটি রক্তনালী সংকুচিত করে, যা হার্ট অ্যাটাক এবং স্ট্রোকের ঝুঁকি বাড়িয়ে দেয়।",
                    Icons.favorite,
                    AppTheme.errorColor,
                  ),
                  _buildArticleCard(
                    context,
                    "প্যাসিভ স্মোকিং (পরোক্ষ ধোঁয়া)",
                    "আপনাদের তামাকের ধোঁয়া আপনার চারপাশের প্রিয়জনদেরও সমানভাবে ক্ষতি করে। শিশুদের শ্বাসকষ্ট ও নিউমোনিয়ার ঝুঁকি বাড়ে।",
                  ...
                  _buildArticleCard(
                    context,
                    "আর্থিক ক্ষতি ও অপচয়",
                    "তামাক কেনা শুধু স্বাস্থ্যের জন্যই নয়, আপনার পকেটের জন্যও ক্ষতিকর। হিসাব করে দেখুন, এই টাকা জমিয়ে আপনি কত আকর্ষণীয় স্বপ্ন পূরণ করতে পারতেন!",
                    Icons.money_off,
                    AppTheme.accentOrange,
                  ),
                  _buildArticleCard(
