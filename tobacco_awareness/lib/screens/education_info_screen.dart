            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildArticleCard(
                    context,
                    "১. বন্ধুত্বপূর্ণ শুরু",
                    "সরাসরি উপদেশ না দিয়ে কৌতূহল বা বন্ধুদের চাপ নিয়ে প্রশ্ন করে আড্ডা শুরু করুন।",
                  ...
                  _buildArticleCard(
                    context,
                    "২. স্বাস্থ্যঝুঁকি",
                    "ফুসফুস ও হার্টের ক্ষতি, স্ট্রোক, মুখের ক্যান্সার এবং স্ট্যামিনা কমে যাওয়ার ভয়ংকর দিকগুলো বুঝিয়ে বলুন।",
                  ...
                  _buildArticleCard(
                    context,
                    "৩. তাৎক্ষণিক লাভ",
                    "ধূমপান ছাড়ার ২০ মিনিট থেকে ৪৮ ঘণ্টার মধ্যে রক্তচাপ স্বাভাবিক হওয়া ও হার্ট অ্যাটাকের ঝুঁকি কমার তথ্য দিন।",
                    Icons.trending_up,
                  ...
                  _buildArticleCard(
                    context,
                    "৪. দীর্ঘমেয়াদী সুফল",
                    "৫ বছরের মধ্যে ফুসফুসের ক্ষমতা বৃদ্ধি এবং স্ট্রোক বা ক্যান্সারের ঝুঁকি অর্ধেক কমে যাওয়ার আশা দেখান।",
                    Icons.auto_awesome,
                    Colors.blue,
                  ),
                  _buildArticleCard(
                    context,
                    "৫. দৃঢ় প্রতিজ্ঞা ও পরিবেশ",
                    "তামাক ছাড়ার শক্ত মনস্থির করুন এবং চোখের সামনে থেকে লাইটার, অ্যাশট্রে ও প্যাকেট ফেলে দিন।",
                  ...
                  _buildArticleCard(
                    context,
                    "৬. সঙ্গ ও বিকল্প",
                    "একাকীত্ব এড়াতে পরিবার বা বন্ধুদের সাথে থাকুন এবং সিগারেটের বদলে চুইংগাম বা আদা-লবঙ্গ চিবান।",
                    Icons.people_outline,
                    Colors.purple,
                  ),
                  _buildArticleCard(
                    context,
                    "৭. মানসিক চাপ ও ছোট লক্ষ্য",
                    "চাপ কমাতে ডিপ-ব্রিথিং বা ধ্যান করুন এবং প্রতিদিন 'আজকে সিগারেট খাব না' এই ছোট লক্ষ্য নিন।",
                  ...
                  _buildArticleCard(
                    context,
                    "৮. পুরস্কার",
                    "প্রতি সপ্তাহে ধূমপানমুক্ত থাকলে বেঁচে যাওয়া টাকা দিয়ে নিজেকে পুরস্কৃত করুন বা পছন্দের খাবার খান।",
                  ...
                  _buildArticleCard(
                    context,
                    "৯. ক্র্যাভিং সামলানো",
                    "তীব্র ইচ্ছে হলে ৫-৪-৩-২-১ গ্রাউন্ডিং টেকনিক ব্যবহার করুন এবং ১০ মিনিটের 'উইথড্রয়াল ওয়েভ' পার করুন।",
                    Icons.waves,
                    Colors.cyan,
                  ),
                  _buildArticleCard(
