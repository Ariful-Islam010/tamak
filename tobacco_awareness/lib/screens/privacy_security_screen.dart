        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              context,
              "তথ্য নিরাপত্তা",
              "আপনার সমস্ত ব্যক্তিগত তথ্য এবং ধূমপান বর্জনের ইতিহাস আমাদের সুরক্ষিত সার্ভারে (Secure Server) সম্পূর্ণ এনক্রিপ্ট অবস্থায় সুরক্ষিত থাকে। আপনার অনুমতি ছাড়া এই ডেটা তৃতীয় কোনো পক্ষের সাথে শেয়ার করা হয় না।",
            ),
