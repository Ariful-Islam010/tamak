        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              "গুগল প্লে স্টোরের পলিসি অনুযায়ী আপনি যেকোনো সময় অ্যাপ ও ব্যাকএন্ড সার্ভার থেকে আপনার সমস্ত ডেটা স্থায়ীভাবে ডিলিট করার আবেদন পাঠাতে পারেন। ইমেইল সাপোর্ট (ariful010a@gmail.com) এ 'Account Deletion Request' সাবজেক্ট দিয়ে মেইল করুন।",
            ),
          ],
        ),
      ),
