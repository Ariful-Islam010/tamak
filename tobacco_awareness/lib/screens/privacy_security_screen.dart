        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              "গুগল প্লে স্টোরের পলিসি অনুযায়ী আপনি যেকোনো সময় অ্যাপ ও ব্যাকএন্ড সার্ভার থেকে আপনার সমস্ত ডেটা স্থায়ীভাবে ডিলিট করতে পারেন। প্রোফাইল ট্যাবের (Profile Tab) নিচে অবস্থিত 'অ্যাকাউন্ট মুছে ফেলুন' বাটনে ক্লিক করে যেকোনো সময় ১-ক্লিকে আপনার সমস্ত ডেটা মুছে ফেলতে পারেন।",
            ),
            const SizedBox(height: 24),
          ],
        ),
